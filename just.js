...
function (_Maybe) {
  ...
  function Just(val) {
    ...
    _defineProperty(_assertThisInitialized(_this), "map", function (func) {
      return _maybe.default.nullable(func(_this._val));
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "getOrElse", function () {
      return _this._val;
    });

    _defineProperty(_assertThisInitialized(_this), "filter", function (func) {
      return _maybe.default.nullable(func(_this._val) ? _this._val : null);
    });

    _defineProperty(_assertThisInitialized(_this), "toString", function () {
      return "Just[".concat(_this._val, "]");
    });
