...
export declare type Monadical<M> = {
    isLeft?: () => boolean;
    isRight?: () => boolean;
    isJust?: () => boolean;
    isNothing?: () => boolean;
...
export declare type EitherResult<T> = Either<any, T>;
export declare type MaybeResult<T> = Maybe<T, any>;
export declare type GetPropOrElse = {
    (path: string): (obj: object) => (defaultVal: any) => any;
    (path: string, obj: object): (defaultVal: any) => any;
    (path: string, obj: object, defaultVal: any): any;
};
export declare type ExtractG = {
    <T>(a: T): any;
};
export declare type MapC = {
    <T, V>(func: T): (container: Monadical<V>) => any;
    <T, V>(func: T, container: Monadical<V>): any;
};
export declare type MapG = {
    <T>(a: T): <V>(b: V) => MapC;
    <T, V>(a: T, b: V): MapC;
};
export declare type ChainC = {
    <T, V>(func: T): (container: Monadical<V>) => any;
    <T, V>(func: T, container: Monadical<V>): any;
};
export declare type ChainG = {
    <T>(a: T): <V>(b: V) => ChainC;
    <T, V>(a: T, b: V): ChainC;
};
export declare type GetOrElseC = {
    <T, V>(val: T): (container: Monadical<V>) => any;
    <T, V>(val: T, container: Monadical<V>): any;
};
export declare type GetOrElseG = {
    <T>(a: T): <V>(b: V) => GetOrElseC;
    <T, V>(a: T, b: V): GetOrElseC;
};
export declare type SafeHandleResult = {
    error: Error;
};
export declare type SafeHandleErrorG = {
...
export declare type IndexableAny = {
    [key: string]: any;
};
export declare type Indexable<T> = {
    [key: string]: T;
};
export declare type ReadableValue = {
    <T, V>(a: T): (b: string) => () => V;
    <T, V>(a: T, b: string): () => V;
};
export declare type Collapse = {
    (a: string): (b: string) => string;
    (a: string, b: string): string;
};
export declare type Normalise = (delim: string) => (a: string) => string;
export declare type WritableValue = {
    <T>(a: T): (b: string) => <U>(c: U) => () => U;
    <T>(a: T, b: string): <U>(c: U) => () => U;
    <T, U>(a: T, b: string, c: U): () => U;
};
export declare type Mappable = {
    <T>(a: T): <V>(b: V) => V;
    <T, V>(a: T, b: V): V;
};
...
export declare type ValidLength = {
    (a: string): (b: number) => boolean;
    (a: string, b: number): boolean;
};
export declare type Joiner = {
    (a: string): <T>(b: T[]) => string;
    <T>(a: string, b: T[]): string;
};
export declare type FuncSpreadT<T> = (...args: any[]) => T;
export declare type FuncSpreadable = (...args: any[]) => any;
export declare type Func1Optional = <A>(a?: A) => any;
export declare type Func1<A> = (a: A) => A;
