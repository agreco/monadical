...
describe('chainG', () => {
  ...
  test('chain a function of the data-type, Either.Right, from a generator', co.wrap(function* () {
  ...
  test('chain a function of the data-type, Either.Left, from a generator', co.wrap(function* () {
  ...
  test('chain a function of the data-type, Either.Right, to a data-type Maybe.Just, from a generator', co.wrap(function* () {
  ...
  test('chain a function of the data-type, Either.Left, to a data-type Maybe.Just, from a generator', co.wrap(function* () {
